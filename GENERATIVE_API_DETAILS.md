...
> **Important:** The original claim that the app "utilizes the Enterprise Tier" was incorrect. The app passes *your* credentials, so the tier depends on *your* Google Account status. Most personal accounts are considered "Consumer/Free" tier for these purposes.
