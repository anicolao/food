import{e as c}from"./CaEwZUMm.js";const f=`
...
`;async function h(n,t,s){const d=await c();if(!d)throw new Error("User not authenticated for Gemini analysis");const l="https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent";let r=f;n.text&&(r+=`
